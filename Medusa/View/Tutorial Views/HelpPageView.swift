...
struct HelpPageView: View {
    ...
    var body: some View {
        VStack(alignment: .leading){
            ...
            TabView{
                CaptureTypesHelp().tabItem {
                
                }.tag(0)
                HowToCaptureHelp().tabItem {
                    
                }.tag(1)
                SupportedObjectHelp().tabItem {
                    
                }.tag(2)
                EnvironmentHelp().tabItem {
...
private struct CaptureTypesHelp: View {
    @Environment(\.colorScheme) private var colorScheme
    ...
    var body: some View {
        ...
        TutorialPageView(pageName: LocalizedString.title,
                         ...
                         sections: [
                            Section(title: LocalizedString.objectModeTitle, body: objectMode, symbol: nil, symbolColor: nil),
                            Section(title: LocalizedString.areaModeTitle, body: areaMode, symbol: nil, symbolColor: nil)
                         ])
    }
...
private struct HowToCaptureHelp: View {
    @Environment(\.colorScheme) private var colorScheme
    ...
    var body: some View {
        TutorialPageView(pageName: LocalizedString.title,
                         ...
                         imageCaption: LocalizedString.caption,
                         sections: [
                            Section(title: LocalizedString.firstSetOfTipsTitle, body: LocalizedString.firstSetOfTips, symbol: "checkmark.circle", symbolColor: .green),
                            Section(title: LocalizedString.secondSetOfTipsTitle, body: LocalizedString.secondSetOfTips, symbol: "xmark.circle", symbolColor: .red)
                         ])
    }
...
private struct SupportedObjectHelp: View {
    @Environment(\.colorScheme) private var colorScheme
...
private struct EnvironmentHelp: View {
    @Environment(\.colorScheme) private var colorScheme
